...
public class GenerarRecompensa : MonoBehaviour//Alam
{
	...
	public float minTime, maxTime; //Con qué frecuencia aparecen los obstáculos
	...
	void Start()
    {
		...
		temporizador = 0.0f; //Inicializar el temporizador
	}
    ...
    void Update()
    {
		...
		if (!Evento.hayEvento)
		{
			...
			{
				Generar();
				temporizador = Random.Range(minTime, maxTime);
			}
		}
        #endregion
    }
